...
func (a *app) routes() http.Handler {
	...
	appMux.HandleFunc("POST /sheets/{id}/stops/{stopID}/zones/{zoneID}/reorder", a.zoneReorder)
	appMux.HandleFunc("POST /sheets/{id}/stops/{stopID}/dispensers/{dispenserID}/reorder", a.dispenserReorder)
	...
	appMux.HandleFunc("POST /stops/{stopID}/sign", a.stopSign)
	appMux.HandleFunc("POST /stops/{stopID}/unsign", a.stopUnsign)
